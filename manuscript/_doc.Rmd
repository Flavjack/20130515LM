...
\newpage
```{r}
#| label: tbl-id.ela3e9ir5gqm
#| tbl-cap: 'Potato genotypes (*Solanum tuberosum* L.) used for water deficit experiment with two commercial varieties and 13 genotypes from an advanced breeding population developed by the International Potato Center (CIP). Source: International Potato Center (CIP).'
...
\newpage
```{r}
#| label: tbl-id.dd4ybu8xyln
#| tbl-cap: 'Response comparison for 18 traits in 15 potato genotypes under Well-Watered (WW) and Water Deficit (WD) conditions. The values for different traits are represented by the mean ± standard deviation with the significance under the t-test with their respective p-values.'
knitr::kable(tibble::tibble(' ' = ''))
```
