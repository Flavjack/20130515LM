...
> Indirect selection between HI vs TWUE!
...
Differences existed among genotypes in total biomass dry weight (g) of well-watered (WW) plants at the end of the experiment, table. Water deficit (WD) treatment had a significant effect (P < 0.001) with an average reduction of around 31% in comparison with the well-watered treatment \@ref(fig:svt). 
