...
Thirteen potato clones were selected from advanced breeding population collection at International Potato Center (CIP) and two commercial varieties, Table (\@ref(tab:gnt)). UNICA (	CIP392797.22) has a good response to warm and dry environments [@demirel2020Physiological; @gutierrez-rosales2007UNICA; @rolando2015Leaf]; and Achirana INTA (CIP720088) known for their earliness and drought tolerance [@schafleitner2007Field]. 
...
Likewise, under drought stress, the tolerance of some genotypes has been associated with rapid recuperation after rehydration (Hu et al., 2010; Zegada-Lizarazu and Monti, 2013).
