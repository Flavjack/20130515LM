...
knitr::include_graphics('articul8/img_0.png')
```
...
knitr::include_graphics('articul8/img_2.png')
```
...
knitr::include_graphics('articul8/img_3.png')
```
...
knitr::include_graphics('articul8/img_4.png')
```
...
The main limitation in the present work was the limited space in the greenhouse to include additional pots to adjust the water requirement in time for each treatment. However, the difference between the water deficit treatment and stress condition was achieved ([@fig-id.olts8je85fk5]) as all the pots have the same source of variation and the error were distributed normally. 
...
**Table S1:** Summary statistics and variance components for 18 traits under water deficit experiment in 15 potato genotypes. Standard deviation (std), Genetic variance (V.g), Error variance (V.e), and plot-based heritability (H2).
...
```{r}
knitr::include_graphics('articul8/img_5.png​')
```
