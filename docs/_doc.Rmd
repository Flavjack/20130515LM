...
knitr::include_graphics('docs/img_0.png')
```
...
knitr::include_graphics('docs/img_1.png')
```
...
knitr::include_graphics('docs/img_2.png')
```
...
#| fig-cap: 'Principal Component Analysis (PCA) from variables measured in 15 potato genotypes under well-watered (WW) and water deficit (WD) conditions. (A) PCA for the variables. (B) PCA for the genotypes under WW and WD.'

knitr::include_graphics('docs/img_3.png')
```
...
knitr::include_graphics('docs/img_5.png')
```
